...
// Fixed delete function - this was causing the infinite recursion
...
async function toggleTaskStatusById(id) {
...
function renderTasks() {
  ...
  elements.tasksGrid.innerHTML = sortedTasks
  ...
  return `
    ...
    overdue ? "overdue" : ""
            ...
            <div class="task-header">
                <button class="task-status-btn" onclick="handleToggleStatus('${
                  task._id
                }')">
                    <span class="material-icons" style="color: ${
                      task.status === "completed" ? "#4caf50" : "#ccc"
                    }">
                        ${
                          ...
                          task.dueDate
                            ...
                            <div class="task-meta-item ${
                              overdue ? "overdue" : ""
                                ...
                                ${
                                  overdue
                                    ? '<span style="font-weight: bold; color: #f44336;">(OVERDUE)</span>'
                                    : ""
                                }
                            </div>
                        `
    ...
    task.priority
                ...
                <div class="task-actions">
                    <button class="btn btn-secondary" onclick="handleEditTask('${
                      task._id
                    }')">
                        <span class="material-icons">edit</span>
                        Edit
                    </button>
                    <button class="btn btn-danger" onclick="handleDeleteTask('${
                      task._id
                    }')">
...
// Fixed global functions for onclick handlers - these were causing the recursion
...
window.handleDeleteTask = (id) => {
  deleteTaskById(id); // Call the renamed function
};

window.handleToggleStatus = (id) => {
  toggleTaskStatusById(id); // Call the renamed function
};
